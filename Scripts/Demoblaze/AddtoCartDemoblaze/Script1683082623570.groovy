...
WebUI.rightClick(findTestObject('Object Repository/Page_STORE/Page_STORE/h2_Samsung galaxy s6'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/Page_STORE/h2_Samsung galaxy s6'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/Page_STORE/h2_Products'), 0)
